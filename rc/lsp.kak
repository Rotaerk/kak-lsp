...
declare-option -docstring "Character to signal a code lens in the gutter" str lsp_code_lens_sign '𝜆'
...
add-highlighter global/lsp_code_lenses flag-lines LineNumbers lsp_code_lenses
